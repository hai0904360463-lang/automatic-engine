  ...
  Future<void> _initLocation() async {
    ...
    _positionStream =
      ...
      if (_lastPosition != null && _lastTimestamp != null) {
        ...
        if (seconds > 0.3) {
          // Đủ thời gian trôi qua để tính toán đáng tin cậy
          final calculatedSpeedMs = distanceMeters / seconds;
          speedKmh = calculatedSpeedMs * 3.6;
        } else {
          // Cập nhật quá nhanh sát nhau, giữ nguyên tốc độ cũ tránh nhảy số ảo
          speedKmh = _speedKmh;
        }
      } else {
        // Lần đầu tiên chưa có điểm trước đó để so sánh, dùng tạm speed hệ thống nếu có
